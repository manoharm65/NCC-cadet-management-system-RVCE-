<div class="twitter-redesign sidebar-collapse">
 ...
 <div class="wrapper">
    <div class="page-header page-header-small" style="background-image: url('assets/image/ncc/33.jpg');">
				               ...
				               <div class="row">
				                <div class="col-md-12">
 								  ...
 								  <select  class="form-control" id="dspmu" name="dspmu" style="background: rgb(23, 23, 23) !important;">
										<option disabled selected>--Are you studying in RVCE College--</option>
				              ...
				              <div class="row">
				                <div class="col-md-12">
 								...
 								<select  class="form-control" id="depart" name="depart" style="background: rgb(23, 23, 23) !important;">
											...
											<option value="2001">Aerospace Engineering</option>
											<option value="2002">Biotechnology</option>
											<option value="2003">Chemical Engineering</option>
											<option value="2004">Civil Engineering</option>
											<option value="2005">Computer Science and Engineering</option>
											<option value="2006">Electrical and Electronics Engineering</option>
											<option value="2007">Electronics and Communication Engineering</option>
											<option value="2008">Electronics and Instrumentation Engineering</option>
											<option value="2009">Industrial Engineering and Management</option>
											<option value="2010">Information Science and Engineering</option>
											<option value="2011">Mechanical Engineering</option>
											<option value="2012">Telecommunication Engineering</option>
											<option value="2013">Artificial Intelligence and Machine Learning</option>
											<option value="2014">Electronics and Computer Engineering</option>
											<option value="2015">Basic Sciences (Physics, Chemistry, Mathematics, and Humanities)</option>
   						...
   						<div class="row">
				                <div class="col-md-12">
									...
									<select class="form-control" id="session" name="session" style="background: rgb(23, 23, 23) !important;">
										...
										<option value="2022-2026">2020-2022-(04 Years)</option>
										<option value="2023-2027">2020-2023-(04 Years)</option>
										<option value="2024-2028">2019-2021-(04 Years)</option>
										<option value="2025-2029">2019-2022-(04 Years)</option>
					              ...
					              <div class="card no-transition">
					                ...
					                <div id="collapseThree" class="collapse" role="tabpanel" aria-labelledby="headingThree">
					                  <div class="card-body">
					                    ...
					                    <div class="row">
							                <div class="col-md-12">
							              <input type="text" class="form-control" value="1 Kar Signal regiment NCC" disabled style="background: rgb(23, 23, 23) !important;">
							                </div>
